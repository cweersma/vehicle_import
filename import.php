...
switch ($info_type){
    ...
    case "--use-spec":
        ...
        $inserts[] = "INSERT INTO l_models (make_id, model_name) SELECT l_makes.make_id, t_sv.model_name FROM t_sv INNER JOIN l_makes using (make_name) LEFT JOIN l_models ON l_makes.make_id = l_models_make_id AND t_sv.model_name = l_models.model_name WHERE model_id IS NULL";
