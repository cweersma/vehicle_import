...
switch ($info_type){
    ...
    case "--use-spec":
        ...
        $inserts[] = "INSERT INTO l_engine_types (engine_type_name) SELECT engine_type FROM t_sv LEFT JOIN l_engineTypes ON t_sv.engine_type = l_engine_types.engine_type_name WHERE engine_type_id IS NULL";
